...
void UiRenderer::renderNarrative(const UiState& state) {
    ...
    const u32 muted = C2D_Color32(190, 202, 213, 255);
    ...
    C2D_DrawRectSolid(8.0F, 18.0F, 0.1F, 304.0F, 158.0F, panel);
    ...
    drawText(page, 142.0F, 180.0F, 0.44F, gold);
    drawText(state.narrativeCanGoBack ? "B/LEWO WSTECZ" : "B ZAMKNIJ", 12.0F, 205.0F, 0.42F, muted);
    drawText("A/PRAWO DALEJ", 166.0F, 205.0F, 0.42F, muted);
    drawText("X POMIN", 118.0F, 224.0F, 0.40F, muted);
    C2D_Flush();
